...
const RotatingRole = ({ roles }: { roles: string[] }) => {
  ...
  return (
    <span className="inline-block overflow-hidden align-middle h-[1.4em]">
...
export default function Intro() {
  ...
  return (
    <section
      ref={ref}
      id="home"
      className="w-full mb-28 sm:mb-40 scroll-mt-[100rem]"
    >
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-12 lg:gap-20 items-center py-8 lg:py-16">
        ...
        <div className="flex flex-col gap-7">
          ...
          {/* Name */}
          <motion.h1
            className="text-[clamp(3rem,7.5vw,5.5rem)] font-bold tracking-tighter leading-[0.88] text-zinc-900 dark:text-zinc-50"
          ...
          {/* Rotating role */}
          <motion.p
            className="text-xl sm:text-2xl text-zinc-500 dark:text-zinc-400 font-light"
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="relative">
            ...
            <div className="absolute -inset-4 rounded-full border border-dashed border-blue-300/50 dark:border-blue-700/30" />
            <div className="absolute -inset-8 rounded-full border border-zinc-200/50 dark:border-zinc-700/25" />
            ...
            <Image
              ...
              quality={95}
              priority
              className="w-56 h-56 sm:w-72 sm:h-72 lg:w-80 lg:h-80 rounded-full object-cover border-4 border-white dark:border-zinc-900 shadow-2xl shadow-zinc-400/20 dark:shadow-zinc-900/60"
            />
          </div>
        </motion.div>
